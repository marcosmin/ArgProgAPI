    ...
    <div className='container'>
      ...
      <div className='center'>
        ...
        <div className='rowTempXHora'>
          ...
          <div className='temperaturasDiaria'>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[0]).slice(-5)} temp={weatherdata.hourly.temperature_2m[0]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[1]).slice(-5)} temp={weatherdata.hourly.temperature_2m[1]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[2]).slice(-5)} temp={weatherdata.hourly.temperature_2m[2]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[3]).slice(-5)} temp={weatherdata.hourly.temperature_2m[3]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[4]).slice(-5)} temp={weatherdata.hourly.temperature_2m[4]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[5]).slice(-5)} temp={weatherdata.hourly.temperature_2m[5]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[6]).slice(-5)} temp={weatherdata.hourly.temperature_2m[6]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[7]).slice(-5)} temp={weatherdata.hourly.temperature_2m[7]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[8]).slice(-5)} temp={weatherdata.hourly.temperature_2m[8]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[9]).slice(-5)} temp={weatherdata.hourly.temperature_2m[9]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[10]).slice(-5)} temp={weatherdata.hourly.temperature_2m[10]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[11]).slice(-5)} temp={weatherdata.hourly.temperature_2m[11]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[12]).slice(-5)} temp={weatherdata.hourly.temperature_2m[12]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[13]).slice(-5)} temp={weatherdata.hourly.temperature_2m[13]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[14]).slice(-5)} temp={weatherdata.hourly.temperature_2m[14]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[15]).slice(-5)} temp={weatherdata.hourly.temperature_2m[15]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[16]).slice(-5)} temp={weatherdata.hourly.temperature_2m[16]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[17]).slice(-5)} temp={weatherdata.hourly.temperature_2m[17]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[18]).slice(-5)} temp={weatherdata.hourly.temperature_2m[18]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[19]).slice(-5)} temp={weatherdata.hourly.temperature_2m[19]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[20]).slice(-5)} temp={weatherdata.hourly.temperature_2m[20]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[21]).slice(-5)} temp={weatherdata.hourly.temperature_2m[21]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[22]).slice(-5)} temp={weatherdata.hourly.temperature_2m[22]} /></div>
            <div className='temperaturaXHora'><CenterHoraTemperatura horaActual={horaActual} hora={String(weatherdata.hourly.time[23]).slice(-5)} temp={weatherdata.hourly.temperature_2m[23]} /></div>
            <div></div>
          </div>
      ...
      <div className='footer'>
        ...
        <div className='indices'>
          ...
          <div className='compIndices'><FooterIndices icono={iconoPrecipitaciones} indice={'PRECIPITACIONES'} valor={ precipitaciones } unidad={'%'} comentario={ comentarioPrecipitaciones } /></div>
        </div>
